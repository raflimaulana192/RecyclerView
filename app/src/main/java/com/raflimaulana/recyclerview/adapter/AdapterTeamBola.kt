package com.raflimaulana.recyclerview.adapter
...
import com.raflimaulana.recyclerview.databinding.ListItemPemainBinding
import com.raflimaulana.recyclerview.model.Pemain

class AdapterTeamBol(private val context : Context,
                     private var data : List<Pemain>?,
                     private val itemclick : OnClickListener)
             : RecyclerView.Adapter<AdapterTeamBol.ViewHolder>() {
